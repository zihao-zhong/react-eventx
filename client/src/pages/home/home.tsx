...
function Home() {
  ...
  return (
    <div className="home">
      ...
      <Row className="home-price-container" gutter={[12, 16]}>
        {priceList.map((item) => (
            ...
            <div className="home-price-item">
              ...
              <Row gutter={12}>
                <Col span={12}>
                  ...
                  <span className="price-item-money">{Number(item.volumeUsd24Hr).toFixed(8) || '-'}</span>
                </Col>
                <Col span={12}>
                  <p className="price-item-sub-title">change:</p>
                  <span
                    className={`price-item-money ${
                      String(item.changePercent24Hr).startsWith('-') ? 'minus' : 'positive'
                    }`}
                  >
